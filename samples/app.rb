...
class App < Sinatra::Application
  ...
  get "/payment/find" do
    ...
    haml :display_hash, :locals => {
      :header => "Retrieving Payment_Rest: #{@payment.id}",
  ...
  get "/payment/execute" do
    ...
    haml :display_hash, :locals => {
      :header => "Execute Payment_Rest: #{@payment.id}",
      :display_hash => @payment }
  end
  ...
  [ 'create_with_credit_card', 'create_with_credit_card_token' ].each do |name|
    get "/payment/#{name}" do
      ...
      haml :display_hash, :locals => {
        :header => "Create Payment_Rest: #{@payment.id}",
        :display_hash => @payment }
    end
  end
  ...
  get "/capture/find" do
    ...
    haml :display_hash, :locals => {
      :header => "Retrieving Captured Payment_Rest: #{@capture.id}",
      :display_hash => @capture }
  end
  ...
  get "/capture/refund" do
    ...
    haml :display_hash, :locals => {
      :header => "Refunding Captured Payment_Rest: #{@refund.sale_id}",
      :display_hash => @refund }
  end
